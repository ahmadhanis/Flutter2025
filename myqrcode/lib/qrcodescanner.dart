...
import 'package:myqrcode/ScanHistoryItem.dart';
import 'package:myqrcode/qr_history_screen.dart';
...
class _QrCodeScannerState extends State<QrCodeScanner> {
  ...
  String _detectType(String data) {
    ...
    if (data.contains('Street') ||
        data.contains('Jalan') ||
        data.contains('Ave')) return 'Address';
  ...
  void _showActionSheet() {
    showModalBottomSheet(
      ...
      builder: (context) {
        ...
        switch (qrType) {
          case 'Link':
            actions.add(_buildSheetButton('Open Link', Icons.link, () {
          ...
          case 'Phone Number':
            actions.add(_buildSheetButton('Call Number', Icons.phone, () {
              launchUrl(Uri.parse(qrText!));
              Navigator.pop(context);
            }));
            break;
          ...
          case 'Email':
            actions.add(_buildSheetButton('Send Email', Icons.email, () {
              launchUrl(Uri.parse(qrText!));
              Navigator.pop(context);
            }));
            break;
            ...
            actions.add(
              ...
              if (await Permission.contacts.request().isGranted) {
                ...
                final name = lines
                    ...
                    .last
                    .trim();
                final telLine = lines.firstWhere((l) => l.contains('TEL:'),
                    orElse: () => '');
                final phone =
          ...
          case 'Address':
            actions.add(_buildSheetButton('Open in Maps', Icons.map, () {
